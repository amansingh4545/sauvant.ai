...
function Faq(){
    return (
        <>
            <div className="bg-white-A700 flex flex-col gap-10 items-center justify-start max-w-[1438px] md:px-10 px-20 sm:px-5 py-[30px] w-full">
                ...
                <Text
                    ...
                    size="txtMontserratBold24Black900"
                >
